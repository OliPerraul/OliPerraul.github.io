---
slug: tutoquest-avatar-attaque-animation
order: 22
title: 7.2 Attaquer les ennemis
...
> ### Étapes à suivre
> 1. ajoutez les animations requises à l'avatar
> 2. modifiez la méthode `playAnimation` afin que les animations d'attaque prennent préséance à d'autres animations
> 3. jouez l'animation à l'intérieur de `attack`
...
---
> ### Étapes à suivre
> 1. ajoutez les animations requises pour l'attaque
> 2. jouez la bonne animation lors de la création
